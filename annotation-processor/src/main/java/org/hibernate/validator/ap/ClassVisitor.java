 ...
 * Each {@link ConstraintCheckError} occurred will be reported using the {@link javax.annotation.processing.Messager} API.
 * <p>
	...
	private void processClassChecks(Element element) {
		try {
			...
			for ( ClassCheck classCheck : classChecks ) {
				errors.addAll( classCheck.execute( element ) );
			}
